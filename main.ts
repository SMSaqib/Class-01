...
let Guest_List=["taha","Rafique","Aresha"]
for (let i = 0; i < 3; i++) {
...
let Change_Guest_List=["taha","Rafique","Sanober"]
for (let val of Change_Guest_List) {
...
let More_Guest_List=["Kashif hameed","taha","Rafique","Sanober","Salman Khan"]
function append(array,x) {
  return array.push(x)
}

append(More_Guest_List,"Rameez Waleed")
for (let val of More_Guest_List ) {
...
let Items_count=More_Guest_List.length
...
let world=["Poland","France","Australia","UAE","Canada"]
//• Print your array in its original order.
console.log(world)
//• Print your array in alphabetical order without modifying the actual list.
const sorteA_Z=[...world].sort();
console.log(sorteA_Z)
//• Show that your array is still in its original order by printing it.
console.log(world)
//• Print your array in reverse alphabetical order without changing the order of the original list.
const RsorteA_Z=[...sorteA_Z].reverse();
...
let Dinner_Guests=["Salman Khan","Rameez Waleed"]
...
const car: { type: string, model: string, year: number } ={ type:"BMW",model:"1 Series" ,year:2019};
...
if(age>=2 && age<4){console.log("toddler")}
//• If the person is at least 4 years old but less than 13, print a message that the person is a kid.
if(age>=4 && age<13){console.log("kid")}
//• If the person is at least 13 years old but less than 20, print a message that the person is a teenager.
if(age>=13 && age<20){console.log("teenager")}
...
if(fruits[0]=="banana"){console.log("I really like",fruits[0],"!!!")}
if(fruits[1]=="apple"){console.log("I really like",fruits[1],"!!!")}
if(fruits[2]=="mango"){console.log("I really like",fruits[2],"!!!")}
if(fruits[0]=="lichi"){console.log("I really like",fruits[0],"!!!")}
if(fruits[0]=="appricot"){console.log("I really like",fruits[0],"!!!")}
...
for(let i=0 ; i<9 ; i++)
{console.log(Ordinal[i])
if(Ordinal[i]==1){console.log("1st")}
else if(Ordinal[i]==2){console.log("2nd")}
else if(Ordinal[i]==3){console.log("3rd")}
...
for (let piz of pizza){console.log(piz)}
//• Modify your for loop to print a sentence using the name of the pizza instead of printing just the name of the pizza. For each pizza you should have one line of output containing a simple statement like I like pepperoni pizza.
for (let piz of pizza){console.log("I like "+piz+" !")}
...
function make_album(artist: string, title: string, tracks?: number) {
  ...
  const A1 = make_album("Sajjad Ali", "ZULM");
  const A2 = make_album("Sonu Nigam", "YAD", 12);
  const A3 = make_album("Arijith Singh", "Wasta", 8);
  ...
  for (let i of magicians){
    console.log(i) }}
    const magicians: string[]= ["Harry Houdin","David Copperfield","David Blaine"]
...
const originalMagicians: string[] = ["Harry Houdin","David Copperfield","David Blaine"];

const unchangedMagicians = make_great([...originalMagicians]);
...
const Car_1 = create_car("Honda", "Civic", { color: "Red" }, { powerWindows: true ,Transmission:"Automatic"});
const Car_2 = create_car("Toyota", "Camry", { color: "Green" }, {powerWindows: true} ,{Transmission:"Automatic"}, {leatherSeats: true, navigation: true });
console.log(Car_1)
console.log(Car_2)